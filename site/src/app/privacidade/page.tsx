...
export const metadata: Metadata = {
  title: "Política de Privacidade — Minha Jornada Diária",
  description: "Saiba como coletamos, usamos e protegemos seus dados no aplicativo Minha Jornada Diária.",
};
    ...
    <div className="min-h-screen bg-[#FAF9F6]">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-[#374151]">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li><strong>Supabase</strong> — banco de dados seguro e autenticação.</li>
              ...
              <li><strong>Herospark</strong> — processamento de pagamentos para o plano Plus (somente para assinantes).</li>
            </ul>
            <p className="leading-relaxed mt-3">
          ...
          <section>
            ...
            <p className="leading-relaxed">
              Podemos atualizar esta Política de Privacidade periodicamente. Quando houver alterações relevantes, notificaremos você por e-mail ou por aviso no aplicativo.
            </p>
          </section>
        ...
        <div className="mt-12 pt-8 border-t border-gray-200 flex flex-wrap gap-4 text-sm text-[#9CA3AF]">
          <Link href="/termos" className="hover:text-[#2D6A4F] transition-colors">
            Termos de Serviço
          </Link>
          <span>·</span>
